...
import com.cclu.springframework.aop.ClassFilter;
import com.cclu.springframework.aop.MethodMatcher;
import com.cclu.springframework.aop.TargetSource;
...
import com.cclu.springframework.test.bean.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void init() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* com.cclu.springframework.test.bean.IUserService.*(..))"));
    }
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* com.cclu.springframework.test.bean.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* com.cclu.springframework.test.bean.IUserService.*(..))");
